...
public class Caseta_Forrmulario {
	private JFrame f;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable(){
			public void run(){
				try {
					Caseta_Forrmulario window = new Caseta_Forrmulario();
	...
	private void initialize(){
		...
		texto1.setBounds(20,115,135,35);
		f.getContentPane().add(texto1);
		...
		BA.setText("Cuantos autos cobro peaje ");
		BA.setBounds(0,85,300,30);
		BA.setFont(new Font("Tahoma", Font.PLAIN, 13));
		BA.setForeground(Color.red);
		BA.setVerticalAlignment(0);
