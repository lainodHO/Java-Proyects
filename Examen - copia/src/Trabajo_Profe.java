...
int o=20;
	...
	private void initialize(){
		...
		olague.setIcon(new ImageIcon ("D:\\Imagenes de eclipse\\fifa.jpg"));
		...
		final	public void mouseClicked(MouseEvent gato)
			{
				...
				olague.setIcon(new ImageIcon ("D:\\Imagenes de eclipse\\c.png"));
				o=o+5;
				...
				if(gato.getModifiers()==16) {
					olague.setIcon(new ImageIcon ("D:\\Imagenes de eclipse\\w.png"));
					o=o-5;
					olague.setBounds(o,80,160,160);
